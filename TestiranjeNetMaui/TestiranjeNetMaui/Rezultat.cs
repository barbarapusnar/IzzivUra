...
namespace TestiranjeNetMaui
{
    ...
    public class NUTS
    {
        public NUTS0 NUTS0 { get; set; }
        public NUTS1 NUTS1 { get; set; }
        public NUTS2 NUTS2 { get; set; }
        public NUTS3 NUTS3 { get; set; }
    }
    ...
    public class UN_M49
    {
        ...
        public string[] statistical_groupings { get; set; }
    }
    ...
    public class Regions
    {
        ...
        public string WESTERN_EUROPE { get; set; }
        public string WORLD { get; set; }
    }

    public class Currency
    {
        public object[] alternate_symbols { get; set; }
